...
zeroSpaceInverseKinematics::zeroSpaceInverseKinematics()
{
...
zeroSpaceInverseKinematics::calculateIK(Eigen::Matrix<double, 7, 1> jointAngles,
...
Eigen::MatrixXd zeroSpaceInverseKinematics::performanceIndex(Eigen::MatrixXd q)
{
    // """
