...
class ImageProcessing(DataHandler):
    ...
    def getMaskFromRGB_applyHSVFilter(
        self, rgbImage: np.array, hMin, hMax, sMin, sMax, vMin, vMax
    ):
    ...
    def filterRGB_applyHSVFilter(
        self, rgbImage: np.array, hMin, hMax, sMin, sMax, vMin, vMax
    ):
        mask = self.getMaskFromRGB_applyHSVFilter(
            rgbImage, hMin, hMax, sMin, sMax, vMin, vMax
        )
